...
async def main():
    ...
    trend = {
        ...
        "production_selection": {
            ...
            "reason": (
                "Controlled local reference-quality benchmark."
            ),
            "rejection_reasons": [],
        },
    }
    ...
    print(
        "[INFO] Waiting for research -> script -> "
        "evidence -> media -> narration -> render.",
        flush=True,
    )
    ...
    try:
        ...
        print(
            " REAL PIPELINE FAILURE - FULL DIAGNOSTIC"
        )
        print(
            "========================================================"
        )
    ...
    video_path = find_new_mp4(before)

    if video_path is None:
        video_path = find_mp4_in_result(
            safe_result
        )
